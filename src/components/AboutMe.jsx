                    ...
                    <ul>
                        <li>
                            <div>
                                ...
                                <p>Learned various electronic calculations and gained a solid understanding of electronic components. I also learned how to program them using Arduino.</p>
                            </div>
                            <div>
                        ...
                        <li>
                            <div>
                                <div>
                                    <div>
                                        <h4>Digital Design and Development</h4>
                                        <p>Bachelor Diploma</p>
                                    </div>
                                    <p>Sep 2023 - ...</p>
                                </div>
                                <p>Learned to design and develop user-friendly web applications using UX/UI principles and technologies like HTML, CSS, JavaScript, ...</p>
                            </div>
                            <div>
                                <svg width="24" height="32" viewBox="0 0 24 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 0C18.6274 0 24 5.37258 24 12C24 18.6274 12 32 12 32C12 32 0 18.6274 0 12C0 5.37258 5.37258 0 12 0ZM12 7C9.23858 7 7 9.23858 7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7Z" fill="#F2F2F2" />
                                </svg>
                                <p>Howest, Kortrijk, Belgium</p>
                            </div>
                        </li>
                    </ul>
                </li>
