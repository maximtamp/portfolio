        ...
        <section id="about-me" className="px-4 mt-10 mb-40 w-min mx-auto overflow-x-hidden">
            ...
            <div className="">
                <ul className="grid grid-cols-[repeat(10,_clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem))] grid-rows-[repeat(2,_clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem))] gap-[clamp(1.5rem,_1.1479rem_+_1.5023vw,_2.5rem)] min-[1160px]:grid-cols-[repeat(5,_clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem))] min-[1160px]:grid-rows-[repeat(5,_clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem))]">
                    ...
                    <li className="w-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] h-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)] row-2 col-start-1 col-end-2 text-black border-8 flex flex-col-reverse justify-center items-center mt-auto min-[1160px]:row-1 min-[1160px]:col-start-1 min-[1160px]:col-end-2">
                    ...
                    <li className="w-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] h-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] row-start-1 row-end-2 col-start-4 col-end-5">
                        <h3 className="visually-hidden">Picture</h3>
                        <img src={photoMe} alt="" />
                    </li>
                    <li className="w-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] h-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)] row-1 col-start-2 col-end-3 bg-black text-white flex flex-col-reverse justify-center items-center pt-3 min-[1160px]:row-2">
                        ...
                        <ul className="flex flex-col items-end">
                            <li className="flex flex-row items-center gap-3">
                                ...
                                <div className="h-[clamp(1rem,_0.912rem_+_0.3756vw,_1.25rem)] w-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)] bg-[#474747]"><div className="h-[clamp(1rem,_0.912rem_+_0.3756vw,_1.25rem)] w-[clamp(9.5rem,_8.6637rem_+_3.5681vw,_11.875rem)] bg-white"></div></div>
                            </li>
                            <li className="flex flex-row items-center gap-3">
                                <h4 className="font-arial text-[clamp(1.25rem,_1.0739rem_+_0.7512vw,_1.75rem)]">English</h4>
                                <div className="h-[clamp(1rem,_0.912rem_+_0.3756vw,_1.25rem)] w-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)] bg-[#474747]"><div className="h-[clamp(1rem,_0.912rem_+_0.3756vw,_1.25rem)] w-[clamp(7.5rem,_6.8398rem_+_2.8169vw,_9.375rem)] bg-white"></div></div>
                            </li>
                        </ul>
                    </li>
                    <li className="w-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)] h-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] row-start-1 row-end-2 col-6 border-8 border-blue flex justify-center min-[1160px]:row-3 min-[1160px]:col-start-1 min-[1160px]:col-end-3 min-[1160px]:w-[clamp(33rem,_24.3732rem_+_36.8075vw,_57.5rem)] min-[1160px]:h-[clamp(10rem,_9.1197rem_+_3.7559vw,_12.5rem)]">
                    ...
                    <li className="w-[clamp(44.375rem,_34.4718rem_+_42.2535vw,_72.5rem)] row-start-1 row-end-2 col-start-7 col-end-10 min-[1160px]:row-start-4 min-[1160px]:row-end-5 min-[1160px]:col-start-1 min-[1160px]:col-end-6 min-[1160px]:w-full">
                        ...
                        <ul className="flex gap-[clamp(1.5rem,_1.1479rem_+_1.5023vw,_2.5rem)] min-[1160px]:grid min-[1160px]:grid-cols-2 min-[1160px]:w-full">
                            <li className="w-[clamp(21.375rem,_16.5775rem_+_20.4695vw,_35rem)] h-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] flex flex-col justify-between bg-black p-[clamp(2rem,_1.2958rem_+_3.0047vw,_4rem)] text-white font-arial min-[1160px]:w-full">
                                <div className="flex flex-col gap-[clamp(1rem,_0.8239rem_+_0.7512vw,_1.5rem)]">
                                    <div className="flex flex-col gap-2">
                                        <div>
                                            <h4 className="font-helvetica text-[clamp(1.5rem,_1.412rem_+_0.3756vw,_1.75rem)] font-bold">Electricity-Electronics</h4>
                            ...
                            <li className="w-[clamp(21.375rem,_16.5775rem_+_20.4695vw,_35rem)] h-[clamp(21.5rem,_19.3873rem_+_9.0141vw,_27.5rem)] flex flex-col justify-between bg-black p-[clamp(2rem,_1.2958rem_+_3.0047vw,_4rem)] text-white min-[1160px]:w-full">
                                <div className="flex flex-col gap-[clamp(1rem,_0.8239rem_+_0.7512vw,_1.5rem)]">
                                    <div className="flex flex-col gap-2">
                                        <div>
                                            <h4 className="font-helvetica text-[clamp(1.5rem,_1.412rem_+_0.3756vw,_1.75rem)] font-bold">Digital Design and Development</h4>
